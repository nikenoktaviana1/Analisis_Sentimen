...
data = pd.read_csv('D:/SKRIPSI/Dataset/LabelKategori_v3.tsv', header = None, delimiter='\t')
...
sum(data_test.Kategori==prediction_labels)/len(prediction_labels)

model_json = model.to_json()
with open('D:/SKRIPSI/Program Separated/Training Models/Model Saved/saved_model_kategori_v3.json','w') as json_file:
  json_file.write(model_json)
model.save_weights("D:/SKRIPSI/Program Separated/Training Models/Model Saved//saved_model_kategori_v3.h5")
print("Model saved to disk")

with open('D:/SKRIPSI/Program Separated/Training Models/Model Saved/saved_Tokenize_Kategori_v3.pickle', 'wb') as handle:
...
plt.title('Loss Model Kategori',fontsize=13)
fig1.savefig('D:/SKRIPSI/Program Separated/Training Models/Plot_training/loss_kategori.png')
plt.show()
...
plt.title('Accuracy Model Kategori',fontsize=13)
fig2.savefig('D:/SKRIPSI/Program Separated/Training Models/Plot_training/acc_kategori.png')
plt.show()
